            ...
            <div className='col-md-6' >
              ...
              <form className="form-customquiz customquiz">
                ...
                <div className="form-group row">
                  ...
                  <div className="col-xs-8">
                    <input name="answer" type="text" className="form-control"  maxLength="25" placeholder="Enter an answer" required onChange={this.handleCorrentAnswer.bind(this)}></input>
